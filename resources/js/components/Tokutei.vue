		...
		<div>
			<table class="p-tokutei__table">
				...
				<tr>
					...
					<td>「銀行振込」にてお支払い頂く際は、別途振り込み手数料をご負担ください。</td>
				</tr>
				<tr>
					<th>販売数量</th>
					<td>特に制限はございません。</td>
				...
				<tr>
					<th>商品代金の<br>支払時期</th>
					<td>銀行振込：お申し込み後7日以内、クレジットカード決済：お申込み時</td>
				</tr>
				<tr>
					<th>引き渡し時期</th>
					<td>決済完了後、即時</td>
				...
				<tr>
					<th>お支払い方法</th>
					<td>銀行振込、クレジット決済にてお支払いください。</td>
				</tr>
				<tr>
					<th>ご返品について</th>
					<td>商品の特性上返品はお受けできません。ご了承下さい。</td>
				</tr>
				<tr>
					<th>ご解約について</th>
					<td>
						解約（退部）は必ずログイン後に
						<!-- todo: 退会のRouterLinkを実装する -->
